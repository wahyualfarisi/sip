            ...
            <form id="form__add__kms" method="posts">
                ...
                <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="berat_badan" step="0.1"  >
                        </div>

                        <div class="form-group">
                            <label>Panjang Badan Lahir</label>
                            <input type="number" class="form-control" name="panjang_badan" step="0.1" >
                        </div>
               </div>
...
<div id="modalSearchBPJS" class="modal" role="dialog">
