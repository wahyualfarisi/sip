                     ...
                     <div class="col-lg-12">
                         <div class="project-details-tab">
                             <ul class="nav nav-tabs res-pd-less-sm">
                                 <li class="active"><a data-toggle="tab" href="#home"><span class="fa fa-plus" ></span> Kunjungan</a>
                                 </li>
                                 <li><a data-toggle="tab" href="#menu1">List Kunjungan</a>
                                 </li>
                             </ul>
                             <div class="tab-content res-tab-content-project">
                                 ...
                                 <div id="menu1" class="tab-pane fade animated fadeIn">
                                     <div class="project-details-completeness" style="margin-top: 20px;">
